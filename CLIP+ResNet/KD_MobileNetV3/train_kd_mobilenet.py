...
class Config:
    ...
    SAVE_DIR = r'研究拓展/CLIP+ResNet/KD_MobileNetV3//checkpoints'
    LOG_FILE = r'研究拓展/CLIP+ResNet/KD_MobileNetV3/runs/kd_mobilenetv3.log'
    ...
    # === 核心修改 1：蒸馏超参数 ===
    TEACHER_WEIGHT_PATH = r'研究拓展/CLIP+ResNet/checkpoints/best_model.pth' # 替换为真实路径
